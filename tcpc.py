...
# clientSocket = context.wrap_socket(soc, server_side=False, server_hostname=server_sni_hostname)
...
# lbl.grid (row=1, column=0, sticky=W)
# lblTurn=Label(rightFrame1, font=('arial', 20, 'bold'), text="Black",padx=2, pady=2, bg="#2E8B57",width=12) 
...
#         # r1=int(input("Enter row for p1 "))
#         # c1=int(input("Enter col for p1 "))
#         r1=int(entry_row.get())
#         c1=int(entry_column.get())
#         valid=change(r1,c1,0)
#         while valid==-1:
#             print("Invalid Position")
#             # r1=int(input("Enter row for p1 "))
...
#         clientSocket.send(pickle.dumps(l))
#         l = pickle.loads(clientSocket.recv(1024))
#         for el in l:
#             print(el)
